...
allowed='^(funding-radar/(calls\.json|news\.json|link_fix_report\.json|link_verification_report\.json|codex_decision_report\.json))$'
...
python3 -m py_compile funding-radar/codex_decide_updates.py funding-radar/import_funding_sources.py funding-radar/sync_calls_from_md.py funding-radar/fix_calls_links.py funding-radar/verify_calls_links.py
