...
python3 -m py_compile funding-radar/import_funding_sources.py funding-radar/sync_calls_from_md.py funding-radar/fix_calls_links.py funding-radar/verify_calls_links.py
