...
allowed='^(funding-radar/(calls\.json|news\.json|link_fix_report\.json|link_verification_report\.json))$'
...
python3 -m py_compile funding-radar/sync_calls_from_md.py funding-radar/fix_calls_links.py funding-radar/verify_calls_links.py
...
git add funding-radar/calls.json funding-radar/news.json funding-radar/link_fix_report.json funding-radar/link_verification_report.json
